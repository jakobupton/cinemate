...
<div class="content">
    <div class="adminItem" id="addMovie">
        ...
        <form action="private/controller/add_movie.php" method="post" enctype="multipart/form-data">
            ...
            <button class="adminSubmitButton" type="submit">Add Movie</button>
        </form>
    </div>
    <div class="adminItem" id="deleteMovie">
        <h1>Delete a movie</h1>
        <form action="private/controller/delete_movie.php" method="post">
            ...
            <button class="adminSubmitButton" type="submit">Delete Movie</button>
        </form>
    </div>
    <div class="adminItem" id="addShowtime">
        <h1>Add a Showtime</h1>
        <form action="private/controller/add_showtime.php" method="post">
            <label for="movie_id">Movie</label>
            <select id="movie_id" name="movie_id" required>
                <option value="" disabled selected>Select a movie</option>
                <?php 
            ...
            <button class="adminSubmitButton" type="submit">Add Showtime</button>
        </form>
    </div>
    <div class="adminItem" id="deleteShowtime">
        <h1>Delete a Showtime</h1>
        <form action="private/controller/delete_showtime.php" method="post">
            ...
            <button class="adminSubmitButton" type="submit">Delete Showtime</button>
        </form>
    </div>
</div>